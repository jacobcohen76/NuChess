package nuchess.ui.feneditor.control;
...
public class FENEditorControl implements Control
{
	private CBoard board;
	private FENEditorView view;
	private int toMove, castlingRights, epSquare, halfmoveClock, plyCount;
	
	public FENEditorControl(CBoard board, FENEditorView view)
	{
		this.board = board;
		this.view = view;
